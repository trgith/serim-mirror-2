...
class MenuElementController extends Controller
{
    ...
    public function store(Request $request){
        ...
        $request->session()->flash('message', 'Elemento creado correctamente');
    ...
    public function update(Request $request){
       ...
       //die();
        ...
        $request->session()->flash('message', 'Elemento del menú actualizado correctamente');
    ...
    public function delete(Request $request){
        ...
        $menus->delete();
        Menurole::where('menus_id', '=', $request->input('id'))->delete();
        $request->session()->flash('message', 'Elemento del menú eliminado correctamento');
